...
public class CG_AutoFarScale extends CommandGroup {
    ...
    public CG_AutoFarScale(boolean startRight) {
    	...
    	if (startRight) {
	    	...
	    	addSequential(new C_DriveForwardRelative(195, .8));
	        addSequential(new C_TurnRelativeAngle(90, .65));
	       addParallel(C_MoveElevatorToPos.fromInches(35));
	        addSequential(new C_DriveForwardRelative(175, .7));
	        addSequential(new C_TurnRelativeAngle(-85, .75));
	        ...
	        addSequential(new C_SetGriffSpeed(-.4));
