...
/**
 *	1. Arms intake wheels and sets them moving
 *  2. Waits for the griffon to sense the cube
 *  3. Stops the wheels, moves cube up, gets intake out of the way
 */
public class CG_CubeCycle extends CommandGroup {
	...
	public CG_CubeCycle() {
		...
		// Wait for sensor
		addSequential(new C_DebugPrint("At sensor part", true));
