...
public class SS_Elevator extends Subsystem {
	...
	public static final int ELEVATOR_SAFE_AREA = ELEVATOR_MAX
			- (int) (TICKS_PER_INCH * 3);
	...
	private final Encoder encoder = new Encoder(RobotMap.ELEVATOR_ENC_1,
			RobotMap.ELEVATOR_ENC_2);
	...
	public void enableBreakMode(boolean breaksEnabled) {
		...
		final NeutralMode mode = breaksEnabled
				? NeutralMode.Brake
				: NeutralMode.Coast;
