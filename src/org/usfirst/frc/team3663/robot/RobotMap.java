...
public class RobotMap {
	...
	public static final int LIMIT_SWITCH_ELEVATOR_TOP = 9;
	
	public static final int LIMIT_SWITCH_ELEVATOR_BOTTOM = 2;
	
	public static final int LIMIT_SWITCH_CUBE_PRESENT = 8; // Optical sensor for
															// griff
	...
	public static final int ELEVATOR_ENC_1 = 0;
	public static final int ELEVATOR_ENC_2 = 1;
